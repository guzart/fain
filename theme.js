...
const buttons = {
  ...
  btnDangerBackgroundColor: colors.brandDanger,
  btnDangerBorderColor: colors.brandDanger,
  btnDangerColor: '#fff',
  ...
  btnPaddingYLg: '.75rem',
  btnPaddingYSm: '.25rem',
  btnInfoBackgroundColor: colors.brandInfo,
  btnInfoBorderColor: colors.brandInfo,
  btnInfoColor: '#fff',
  btnPrimaryBackgroundColor: colors.brandPrimary,
  btnPrimaryBorderColor: colors.brandPrimary,
  btnPrimaryColor: '#fff',
  btnSecondaryBackgroundColor: '#fff',
  btnSecondaryBorderColor: '#ccc',
  btnSecondaryColor: colors.grayDark,
  btnSuccessBackgroundColor: colors.brandSuccess,
  btnSuccessBorderColor: colors.brandSuccess,
  btnSuccessColor: '#fff',
  btnWarningBackgroundColor: colors.brandWarning,
  btnWarningBorderColor: colors.brandWarning,
  btnWarningColor: '#fff',
};
